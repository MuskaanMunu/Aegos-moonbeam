...
const Home = (props) => {
  ...
  let actualWalletFunds = homeData.walletFunds.map(row => (
    ...
    row.fundName==='DEV'? {...row, value: truncate(metaMaskBalance), amount: truncate(metaMaskBalance * 1.79637372)}: row
          ...
          {isLoading ? (
            ...
            <div className={classes.NoFundsContainer}>
              <Typography>{chainConnected ? "No Funds Found" :
                <>
                  Our contracts work on Moonbase Alpha Testnet.
                  <br/>
                  Please switch to Moonbase Alpha Testnet to see the funds.
                  <br/>
